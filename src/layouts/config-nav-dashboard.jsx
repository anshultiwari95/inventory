...
export const navData = [
   ...
   */
  {
    ...
    items: [
      ...
      { title: 'Dashboard', path: '/dashboard', icon: ICONS.course },
    ],
  },
  /**
   * Masters
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'List', path: paths.dashboard.product.root },
          { title: 'Create', path: paths.dashboard.product.new },
          { title: 'Update', path: paths.dashboard.product.demo.edit },
          { title: 'Delete', path: paths.dashboard.product.demo.details },
        ],
      },
      {
        title: 'User',
        ...
        children: [
          ...
          { title: 'Details', path: paths.dashboard.user.root },
        ],
      },
      // {
      //   title: 'Invoice',
   ...
   */
  {
    ...
    items: [
      ...
      { title: 'Test 1', path: paths.dashboard.root, icon: ICONS.dashboard },
      { title: 'Test 2', path: paths.dashboard.general.ecommerce, icon: ICONS.ecommerce },
    ],
  },
  {
    subheader: 'Report',
